...
import { User, fitnessDataToJson } from "./model/user";
import { Question, questToFitnessData } from "./model/questionaire";
import Questionnaire from "./components/questionnaire/Questionnaire";
import Guide from "./pages/GuidePage";
import UserInfoConfirmationPage from "./pages/UserInfoConfirmationPage";
...
export default function HomePage() {
  ...
  return (
    <div className="bg-secondary-bg w-full font-custom md:h-screen min-h-[100dvh]">
